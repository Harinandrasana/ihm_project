...
const usePdf = () => {
    const generatePDF = () => {
        ...
        // Adapter les données de paies pour le format du PDF
        const formattedData = [
            ["N° Payement", "Identifiant Employe", "Date du Paiement", "Salaire Net", "Salaire Brut", "Total Déduit", "Total Avantage"],
           ...paiesData.map(paie => [
                paie.idPaie,
                paie.idEmploye,
                paie.datePaie,
        ...
        doc.autoTable({
            ...
            head: [formattedData[0]], // En-tête du tableau
            body: formattedData.slice(1), // Corps du tableau (à partir de la deuxième ligne)
        });
...
// Dans votre fichier usePdf.js

// const usePdf = () => {
//     const generatePDF = (paiesData) => {
//         // Créer un nouveau document PDF
//         const doc = new jsPDF();
...
//         // Générer le tableau avec les données adaptées
//         doc.autoTable({
//             startY: 20, // Position de départ du tableau en y
//             head: [formattedData[0]], // En-tête du tableau
//             body: formattedData.slice(1), // Corps du tableau (à partir de la deuxième ligne)
